<%@ Page Language="C#" AutoEventWireup="true" CodeFile="financeManageRequests.aspx.cs" Inherits="financeManageRequests" %>
            ...
            <asp:Repeater ID="rptRequests" runat="server">
                <ItemTemplate>
                    <div class="request-card">
                        ...
                        <asp:TextBox ID="txtComment" runat="server" TextMode="MultiLine" Rows="3" CssClass="form-control" Text='<%# Eval("FinanceComments") %>' placeholder="Enter your comment"></asp:TextBox>
