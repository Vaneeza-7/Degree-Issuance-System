<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IssueTranscript.aspx.cs" MasterPageFile="~/Site.master" Inherits="IssueTranscript" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <form id="form1" runat="server" >
       ...
       <div style="margin-left: 4px;margin-top: 25px; height: 42px;">
            ...
            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" Text="Issue Transcript"></asp:Label>
        </div>
    ...
    <ItemTemplate>
        <%# Convert.ToBoolean(Eval("FinanceApproved")) ? "✔️" : "Awaiting" %>
                ...
                <asp:TemplateField HeaderText="Actions">
                    <ItemTemplate>
                        <asp:Button ID="btnIssueTranscript" runat="server" Text="Issue Transcript" CommandName="IssueTranscript" CommandArgument='<%# Eval("Token") + "," + Eval("UserID") %>' CssClass="btn btn-dark btn-sm" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
            </asp:GridView>
